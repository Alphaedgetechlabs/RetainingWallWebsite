...
import melbourneServiceImg from "@/assets/melbourne-service-area.webp";

const QUOTE_URL = "/quote";
const Melbourne = () => {
  useDocumentTitle("Melbourne Retaining Wall Quotes — Get 3 Free Quotes in Minutes");
  ...
  const recentProjects = [{
    ...
    rating: 5,
    review: "Very happy with the service provided. The contractors were on time and the quality of the retaining wall is excellent."
  }, {
    suburb: "St Kilda",
    ...
    rating: 5,
    review: "Couldn't be happier with the outcome. The retaining wall is beautiful and the support throughout was excellent."
  }];
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">Professional retaining wall installation and repair services across Greater Melbourne. Local tradies, trusted by 2,800+ Melbourne homeowners.</p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="aspect-[4/3] rounded-2xl overflow-hidden shadow-elegant">
                <img alt="Melbourne Retaining Wall Projects" className="w-full h-full object-cover" src={melbourneServiceImg} />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="accent-gradient rounded-2xl p-12 shadow-elegant">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Ready to Get Your Melbourne Retaining Wall Installed?
            </h2>
