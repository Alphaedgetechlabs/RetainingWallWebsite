...
const Contact = () => {
  ...
  const contactInfo = [{ icon: Phone, title: "Phone", details: "0481 752 344", subtext: "24 Hours 7 Days A Week" }, { icon: Mail, title: "Email", details: "info@quotemyretainingwall.com.au", subtext: "We reply within hours" }, { icon: MapPin, title: "Service Areas", details: "All Major Cities", subtext: "Sydney, Melbourne, Brisbane & more" }];
      ...
      <section className="relative pt-32 pb-20 overflow-hidden flex items-center justify-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground mb-8"><p className="text-lg text-muted-foreground mb-8">Have questions about retaining walls? Our friendly team is ready to help.</p> Our friendly team is ready to help.</p>
          </div>
        </div>
      </section>
