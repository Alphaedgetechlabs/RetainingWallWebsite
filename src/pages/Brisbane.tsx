...
import brisbaneServiceImg from "@/assets/brisbane-service-area-2.webp";
import { navigateTo } from "@/lib/spa-navigate";

const QUOTE_URL = "/quote";
const Brisbane = () => {
  useDocumentTitle("Brisbane Retaining Wall Quotes — Get 3 Free Quotes in Minutes");
  ...
  const recentProjects = [{
    suburb: "Paddington",
    type: "Concrete Sleeper Retaining Wall",
    rating: 5,
    review: "The whole process was easy and well managed. The team arrived on schedule and the retaining wall turned out great."
  }, {
    suburb: "New Farm",
    type: "Timber Retaining Wall",
    rating: 5,
    review: "Quality work backed by reasonable pricing. A solid choice for anyone needing retaining walls."
  }, {
    suburb: "West End",
    type: "Steel Retaining Wall",
    rating: 5,
    review: "The final result went beyond what we expected. The retaining wall looks great and the customer service was outstanding."
  }];
  return <div className="min-h-screen bg-background">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-6">Brisbane's Most Trusted<br /><span className="text-gradient">Retaining Wall Specialists</span></h1>
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">Professional retaining wall installation and repair services across Greater Brisbane. Local tradies, trusted by 1,500+ Brisbane homeowners.</p>
      ...
      <section className="py-20 bg-muted/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12"><h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Recent Brisbane Projects</h2><p className="text-lg text-muted-foreground max-w-2xl mx-auto">See what your neighbours are saying about their retaining wall projects</p></div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-3"><div className="w-6 h-6 accent-gradient rounded-full flex items-center justify-center flex-shrink-0 mt-1"><span className="text-white text-xs font-bold">✓</span></div><div><h3 className="font-semibold text-foreground mb-1">Quality</h3><p className="text-muted-foreground text-sm"> Local expert retaining wall contractors on all installations.                                          </p></div></div>
              </div>
            </div>
            <div className="relative"><div className="aspect-[4/3] rounded-2xl overflow-hidden shadow-elegant"><img alt="Brisbane Retaining Wall Projects" className="w-full h-full object-cover" src={brisbaneServiceImg} /></div></div>
          </div>
        </div>
      </section>
      <section className="py-20 bg-muted/30">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="accent-gradient rounded-2xl p-12 shadow-elegant"><h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Ready to Get Your Brisbane Retaining Wall Installed?</h2><p className="text-white/90 text-lg mb-8 max-w-2xl mx-auto">Join 1,000's of happy Brisbane homeowners. Get your free quotes in 60 seconds.</p><Button variant="secondary" size="lg" onClick={handleQuoteClick}>Get Free Brisbane Quotes</Button></div>
        </div>
      </section>
      <Footer />
    </div>;
