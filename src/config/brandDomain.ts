...
// TODO: Temporary lock — app is hardcoded to 'retaining-wall' regardless of hostname.
// To switch trade: change 'retaining-wall' below to 'fencing' | 'decking' | 'landscaping'.
...
const tradeType: TradeType = 'retaining-wall';
