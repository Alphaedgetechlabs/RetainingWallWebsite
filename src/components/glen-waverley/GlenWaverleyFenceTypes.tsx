...
const GlenWaverleyFenceTypes = ({ onQuoteClick }: GlenWaverleyFenceTypesProps) => {
    ...
    <section id="fence-types" className="py-12 sm:py-20" style={{ backgroundColor: "hsl(215 40% 18%)" }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10 sm:mb-16">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-4">Choose Your Perfect Retaining Wall in Glen Waverley</h2>
          <p className="text-base sm:text-xl text-white/70 max-w-3xl mx-auto px-4">Discover Glen Waverley retaining wall options tailored to your needs.</p>
        </div>
        ...
        <div className="mt-16 text-center">
          <div className="card-gradient rounded-2xl p-8 shadow-soft border border-border">
            ...
            <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">Our expert Glen Waverley team can help you select the perfect retaining wall solution.</p>
