...
const HowItWorks = ({ onQuoteClick }: HowItWorksProps) => {
  const steps = [
    {
      icon: Send,
      title: "Click Quotes",
    ...
    <section className="py-12 sm:py-20 bg-background relative overflow-hidden">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-10 sm:mb-16">
          ...
          <p className="text-base sm:text-lg text-muted-foreground">Get your retaining wall project started in 3 easy steps</p>
        </div>
