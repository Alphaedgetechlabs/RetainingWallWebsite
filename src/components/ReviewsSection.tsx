  ...
  const reviews = [
    {
      ...
      location: "Sydney, NSW",
      rating: 5,
      text: "Such a smooth and easy process! Three quotes arrived almost instantly, and the contractor I picked did a flawless job. My new concrete sleeper retaining wall looks stunning — I'm absolutely thrilled!",
      project: "Concrete Sleeper Retaining Wall – 12m"
    },
    {
      name: "Mark",
      location: "Melbourne, VIC",
      rating: 5,
      text: "Super impressed! The quotes were spot-on, and the contractor I chose was fantastic from day one. They finished earlier than promised, and the retaining wall looks perfect. Highly recommended!",
      project: "Timber Sleeper Retaining Wall – 18m"
    },
    {
      name: "James",
      ...
      project: "Block Retaining Wall – 15m"
    },
    {
      name: "Jessica",
      location: "Sydney, NSW",
      ...
      project: "Stone & Sandstone Retaining Wall – 10m"
    }
  ];

  return (
    <section id="reviews" className="py-12 sm:py-20 bg-muted/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-10 sm:mb-16">
          ...
          <p className="text-base sm:text-xl text-muted-foreground max-w-3xl mx-auto px-4">
            Read what our customers say about their retaining wall experience with our platform
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 mb-12">
          {reviews.map((review, index) => (
            <Card key={index} className="shadow-strong hover:shadow-accent transition-smooth">
