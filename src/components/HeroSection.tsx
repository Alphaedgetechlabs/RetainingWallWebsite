        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-start lg:items-center">
          ...
          <div className="text-white space-y-4 sm:space-y-6 lg:space-y-8">
            ...
            <div className="flex items-center space-x-2 text-accent">
              ...
              <span className="text-xs sm:text-sm font-medium whitespace-nowrap">Australia's #1 Retaining Wall Quote Platform — Quotes Within Minutes.</span>
            </div>

            {/* Main Headline */}
            <div className="space-y-2 sm:space-y-3 lg:space-y-4">
              <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold leading-tight">
                Get Free <span className="block text-accent">Retaining Wall Quotes</span>
                in Minutes
              </h1>
              <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-100 max-w-lg">
                Compare Prices & Save on Your Retaining Wall Installation — only verified, top-rated retaining wall contractors quote on your job.
              </p>
            </div>
            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-4 lg:gap-6 pt-2 sm:pt-4">
              ...
              <div className="text-center">
                <div className="text-base sm:text-lg lg:text-2xl font-bold text-accent">10,000+</div>
                <div className="text-[10px] sm:text-xs lg:text-sm text-gray-200">Retaining Walls Quoted</div>
              </div>
            </div>
          </div>
            ...
            <div className="grid gap-3 sm:gap-4">
              <div className="card-gradient rounded-lg sm:rounded-xl p-3 sm:p-4 lg:p-6 shadow-soft border border-white/20">
                <div className="flex items-start space-x-3 sm:space-x-4">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-muted-foreground text-xs sm:text-sm">Homeowners across Australia count on us for their retaining wall solutions at competitive and affordable prices, without compromising on quality.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="card-gradient rounded-lg sm:rounded-xl p-3 sm:p-4 lg:p-6 shadow-soft border border-white/20">
                <div className="flex items-start space-x-3 sm:space-x-4">
                  ...
                  <div className="min-w-0 flex-1">
                    <h3 className="font-semibold text-foreground mb-1 sm:mb-2 text-sm sm:text-base">Australia's Most Reliable Retaining Wall Professionals</h3>
                    <p className="text-muted-foreground text-xs sm:text-sm">Quotes are sourced only from screened, reviewed, and highly-rated retaining wall contractors in your suburb.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="card-gradient rounded-lg sm:rounded-xl p-3 sm:p-4 lg:p-6 shadow-soft border border-white/20">
                <div className="flex items-start space-x-3 sm:space-x-4">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-muted-foreground text-xs sm:text-sm">Get retaining wall quotes from local contractors in minutes — no matter where you are in Australia.</p>
                  </div>
                </div>
              </div>
            </div>
