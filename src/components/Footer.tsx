...
const Footer = () => {
  ...
  const retainingWallServices = [
    { name: "Concrete Sleeper Retaining Wall", href: "/colorbond-fencing" },
    { name: "Timber Sleeper Retaining Wall", href: "/timber-fencing" },
    { name: "Block Retaining Wall", href: "/pool-fencing" },
    { name: "Stone & Sandstone Retaining Wall", href: "/aluminium-fencing" },
    { name: "Gabion Retaining Wall", href: "/feature-fencing" },
    { name: "Retaining Wall Repairs", href: "/fence-repairs" },
    { name: "Engineered Retaining Wall", href: "/glass-fencing" },
    { name: "Retaining Wall Replacement & Removal", href: "/chain-link-fencing" },
  ];
  ...
  const serviceAreas = [
    ...
    { name: "Hobart", href: "/hobart" },
    { name: "Darwin", href: "/darwin" },
  ];
      ...
      <div className="border-b border-primary-foreground/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center">
            <h3 className="text-2xl font-bold mb-2">Stay Updated with Retaining Wall Tips</h3>
            <p className="text-primary-foreground/80 mb-6 max-w-2xl mx-auto">
              Get the latest retaining wall trends, maintenance tips, and exclusive offers delivered to your inbox
            </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-sm whitespace-nowrap">info@quotemyretainingwall.com.au</span>
              </div>
              <div className="flex items-center space-x-3">
          ...
          <div className="lg:col-span-2">
            <h4 className="text-lg font-semibold mb-6">Retaining Wall Services</h4>
            <ul className="grid grid-cols-2 gap-3">
              {retainingWallServices.map((link) => (
                <li key={link.name}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
            <div className="text-sm text-primary-foreground/80">
              © 2026 QuoteMyRetainingWall. All rights reserved.
            </div>
