      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8 sm:mb-12">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-primary mb-4">
            Calculate Your Retaining Wall Cost
          </h2>
          <p className="text-base sm:text-xl text-muted-foreground max-w-3xl mx-auto px-4">
            Get an instant estimate for your retaining wall project with our advanced calculator
          </p>
        </div>
            ...
            <CardHeader>
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <CardDescription className="text-base">Compare quotes from top local retaining wall contractors</CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent className="space-y-6">
              <p className="text-muted-foreground">
                Answer a few quick questions and we'll connect you with verified retaining wall experts in your area. 
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm">Tell us about your retaining wall project</span>
                </div>
                <div className="flex items-center gap-3">
          ...
          <div className="space-y-6">
            <Card className="card-gradient shadow-soft">
              <CardContent className="p-6 space-y-4">
                <h3 className="font-semibold text-primary mb-4">Why Choose Retaining Wall Quotes Online?</h3>
