...
const QuoteFunnelForm = ({ open, onOpenChange }: QuoteFunnelFormProps) => {
  ...
  const handleSubmit = async () => {
    ...
    toast({
      title: "Success! 🎉",
      description: "We're connecting you with top local retaining wall pros now.",
    });
          ...
          <div className="min-h-[400px]">
              ...
              <div className="space-y-6 animate-in fade-in duration-500">
                <div>
                  <DialogTitle className="text-2xl md:text-3xl font-bold mb-3">
                    Let's get your retaining wall job sorted — it only takes 60 seconds.
                  </DialogTitle>
                  <DialogDescription className="text-base flex items-center gap-2">
                    <Star className="w-5 h-5 text-accent fill-accent" />
                    We'll match you with trusted local retaining wall pros rated <span className="font-semibold text-accent">4.8★</span> by homeowners near you.
                  </DialogDescription>
                </div>

                <div className="space-y-3">
                  <Label htmlFor="jobType" className="text-base font-medium">
                    What kind of retaining wall work do you need?
                  </Label>
                  <Select value={formData.jobType} onValueChange={(value) => updateFormData({ jobType: value })}>
                    <SelectTrigger className="h-12 text-base">
                      <SelectValue placeholder="Select your retaining wall needs..." />
                    </SelectTrigger>
                    <SelectContent>
                      <SelectItem value="new-fence">New Retaining Wall Installation</SelectItem>
                      <SelectItem value="repair">Retaining Wall Repair</SelectItem>
                      <SelectItem value="replacement">Retaining Wall Replacement</SelectItem>
            ...
            {currentSlide === 1 && (
              <div className="space-y-6 animate-in fade-in duration-500">
                ...
                <div className="space-y-3">
                  ...
                  <Textarea
                    id="description"
                    placeholder="e.g. Replace broken retaining wall along the backyard."
              ...
              <div className="space-y-6 animate-in fade-in duration-500">
                <div>
                  ...
                  <DialogDescription className="text-base flex items-center gap-2">
                    ...
                    We'll connect you only with <span className="font-semibold text-accent">verified retaining wall experts</span> in your area.
                  </DialogDescription>
                </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        We've already helped <span className="font-semibold text-foreground">2,600+ homeowners</span> get quality retaining walls in your area.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            {currentSlide === 4 && (
              <div className="space-y-6 animate-in fade-in duration-500">
                <div>
                  <DialogTitle className="text-2xl md:text-3xl font-bold mb-3">
                    Almost there — where can our retaining wall experts reach you?
                  </DialogTitle>
                  <DialogDescription className="text-base">
              ...
              <div className="space-y-6 animate-in fade-in duration-500">
                ...
                <div className="space-y-3 bg-muted/50 rounded-lg p-4">
                  <div className="flex items-center gap-2 text-sm">
                    ...
                    <span className="font-medium">Over 2,600 retaining wall jobs completed in your area</span>
                  </div>
                  <div className="flex items-center gap-2 text-sm">
                    <Shield className="w-4 h-4 text-accent" />
