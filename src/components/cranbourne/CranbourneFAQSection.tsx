...
const CranbourneFAQSection = ({
  ...
  const faqs = [{
    ...
    question: "Do I need my neighbour's approval for a new boundary retaining wall in Cranbourne?",
    answer: "Yes — communication with your neighbour is essential. Boundary retaining walls require both parties to agree on the retaining wall height, materials, and cost sharing. In most cases, a quick conversation is enough to reach an agreement, and formal retaining wall notices are only needed if there's a dispute or your neighbour disagrees with the proposed retaining wall."
  }, {
    question: "How close to the boundary can I build my retaining wall in Cranbourne?",
  ...
  return <section className="py-20 bg-gradient-to-b from-background to-secondary/30">
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="text-center mb-12 animate-fade-in">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">Got questions about retaining walls in Cranbourne? We've got answers. Here's everything you need to know about getting your perfect retaining wall installed in Cranbourne.</p>
        </div>
        ...
        <div className="text-center mt-12 p-8 rounded-2xl bg-gradient-to-r from-primary/5 via-accent/5 to-primary/5 border border-accent/20">
          ...
          <p className="text-muted-foreground mb-6">Our local retaining wall experts in Cranbourne are here to help. Get your free quotes and ask them anything!</p>
